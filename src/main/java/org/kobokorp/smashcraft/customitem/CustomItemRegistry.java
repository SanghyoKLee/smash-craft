...
public class CustomItemRegistry {
    public static void registerAll(CustomItemManager manager, CooldownManager cooldownManager, MovementTracker movementTracker, TripleJumpListener tripleJumpListener, DamageManager damageManager) {
        ...
        manager.register(new VitalApple(cooldownManager, damageManager));
    }
}